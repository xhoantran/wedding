...
const translations = {
  ...
  vi: {
    ...
    rsvp: {
      ...
      thankYou: "Xin Cảm Ơn!",
      thankYouMessage:
        "Chúng tôi đã nhận được phản hồi và rất mong được cùng quý khách chia sẻ niềm vui.",
    ...
    guestWishes: {
      ...
      nameLabel: "Quý danh *",
      messageLabel: "Lời chúc của quý khách *",
      messagePlaceholder: "Chúc đôi bạn trẻ trăm năm hạnh phúc...",
      send: "Gửi Lời Chúc",
      sending: "Đang gửi...",
      thankYou: "Xin cảm ơn lời chúc của quý khách!",
